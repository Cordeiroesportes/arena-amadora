...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Se a pessoa veio da home já com um esporte escolhido, respeita o filtro.
  const modalidadeDaUrl = new URLSearchParams(window.location.search).get("modalidade");
  if (modalidadeDaUrl) filtroModalidade.value = modalidadeDaUrl;
  ...
  [filtroModalidade, filtroGenero, filtroCategoria].forEach(function (el) {
